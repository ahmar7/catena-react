    ...
    <section className="w-full">
      <div className="flex w-full flex-col items-center">
        <div className="relative">
          <img className="logo-c" src={LogoY} alt="cf-jit" style={{}} />
        </div>
        <div className="flex w-full flex-col no-padi items-center justify-start px-2 sm:px-0">
          <span className="mb-10 text-16" style={{ color: "#c54a85" }}>
            Protocol Y
          </span>
