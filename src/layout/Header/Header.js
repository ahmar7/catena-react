...
const Header = () => {
  ...
  return (
    <div>
      ...
      <div
        className="addbloa backdrop-filter-blur fixed top-0 z-50 h-[53px] w-full border-b text-[14px] md:h-[87px]"
        style={{
          backgroundColor: "white",
          borderColor: "rgba(255, 255, 255, 0.06)",
        }}
      >
        <div className="tpm flex h-full w-full items-center justify-between px-[20px] md:hidden">
          <Link
